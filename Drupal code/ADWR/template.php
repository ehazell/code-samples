...
function adwr_preprocess_node(&$vars) {
 ...
 */
function adwr_preprocess_page(&$vars) {
 ...
 */
function adwr_process_page(&$vars) {
 ...
 */
function adwr_preprocess_html(&$vars) {
 ...
 * color module support
 */
function adwr_process_html(&$vars) {
  if (module_exists('color')) {
 ...
 */
function adwr_preprocess_views_view(&$vars) {
 ...
 */
function adwr_date_nav_title($params) {
...
function adwr_preprocess_region(&$vars) {
  switch ($vars['region']) {
    case 'preface_first':
    case 'preface_second':
    case 'preface_third':
